...
<div class="container clearfix">
    ...
    <div class="wrapper">
        ...
        <div class="sns">
            <?php if(have_posts()): while(have_posts()):the_post(); ?>
            <a href="<?php echo post_custom('homepage'); ?>" class="sns_item"><i class="fa fa-home fa-fw" aria-hidden="true"></i></a>
            <a href="<?php echo post_custom('twitter'); ?>" class="sns_item"><i class="fa fa-twitter fa-fw" aria-hidden="true"></i></a>
            <a href="<?php echo post_custom('facebook'); ?>" class="sns_item"><i class="fa fa-facebook-square fa-fw" aria-hidden="true"></i></a>
        ...
        <div class="contents">
            ...
            <div class="contents_card contents_money">
                <h2 class="contents_heading contents_title">年間比</h2>
                <div class="contents_icon">
